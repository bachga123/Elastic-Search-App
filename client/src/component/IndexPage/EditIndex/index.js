...
import { CDBTableHeader, CDBTableBody, CDBTable, CDBBtn, CDBContainer, CDBCard, CDBCardBody, CDBDataTable } from "cdbreact";
              ...
              <div style={{ display: "auto" }}>
                ...
                <div style={{ display: "flex", margin: "10px" }}>
                  ...
                  <Form.Select aria-label="Default select example" style={{ height: '40px', marginLeft: '10px', width: '170px' }} onChange={handleOnChangeOption}>
                    ...
                    {data.hits ? Object.keys(data.hits[0]._source).map(key => <option key={key} value={key}>{key}</option>) : null}
                  </Form.Select>
